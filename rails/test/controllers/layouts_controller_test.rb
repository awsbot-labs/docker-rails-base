...
class LayoutsControllerTest < ActionController::TestCase
  ...
  test "should get backend layouts default flipped" do
    sign_in users(:one)
    get :default_flipped
    assert_template layout: "layouts/default_flipped"
    assert_response :success
  end
  ...
  test "should get backend layouts header static" do
    sign_in users(:one)
    get :header_static
    assert_template layout: "layouts/header_static"
    assert_response :success
  end
  ...
  test "should get backend layouts sidebar mini hoverable" do
    ...
    assert_template layout: "layouts/sidebar_mini_hoverable"
    assert_response :success
  end
  ...
  test "should get backend layouts side overlay hoverable" do
    ...
    assert_template layout: "layouts/side_overlay_hoverable"
    assert_response :success
  end
  ...
  test "should get backend layouts side overlay open" do
    ...
    assert_template layout: "layouts/side_overlay_open"
    assert_response :success
  end
  ...
  test "should get backend layouts side native scrolling" do
    ...
    assert_template layout: "layouts/side_native_scrolling"
    assert_response :success
  end
